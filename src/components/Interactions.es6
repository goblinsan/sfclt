  ...
  render() {
    return (
      <div id="interactionsContainer">
        <RollOver icon="MoneyButton.svg" slide="3" itemNumber="1" iconLocation={['22vw','35vh']} textPosition="top-left" />
        <RollOver icon="PriceTagButton.svg" slide="3" itemNumber="2" iconLocation={['64vw','30vh']} textPosition="right" />
