  ...
  render() {
    return (
      <div id="interactionsContainer">
        ...
        <Graphic icon="peopleIcon.png" slide="3" itemNumber="3" iconLocation={['28vw',0]} initHouseSize={this.state.houseSize} relWidth='4vw' currentSlide={this.state.currentSlide} />
        ...
        <Graphic icon="peopleIcon.png" slide="7" itemNumber="7" iconLocation={['27vw',0]} initHouseSize={this.state.houseSize} relWidth='4vw' currentSlide={this.state.currentSlide} />
        ...
        <RollOver icon="StabilityButton.svg" slide="7" itemNumber="3" iconLocation={['55vw',.7]} textPosition="left" currentSlide={this.state.currentSlide} text={this.state.rolloverText} />
        ...
        <Graphic icon="peopleIcon.png" slide="9" itemNumber="2" iconLocation={['24vw',0]} initHouseSize={this.state.houseSize} relWidth='4vw' currentSlide={this.state.currentSlide} />



        <Graphic icon="peopleIcon.png" slide="10" itemNumber="1" iconLocation={['24vw',0]} initHouseSize={this.state.houseSize} relWidth='4vw' currentSlide={this.state.currentSlide} />
        <Graphic icon="peopleIcon.png" slide="11" itemNumber="1" iconLocation={['24vw',0]} initHouseSize={this.state.houseSize} relWidth='4vw' currentSlide={this.state.currentSlide} />
        <Graphic icon="peopleIcon.png" slide="12" itemNumber="1" iconLocation={['24vw',0]} initHouseSize={this.state.houseSize} relWidth='4vw' currentSlide={this.state.currentSlide} />
        ...
        <Graphic icon="peopleIcon.png" slide="13" itemNumber="1" iconLocation={['24vw',0]} initHouseSize={this.state.houseSize} relWidth='4vw' currentSlide={this.state.currentSlide} />
        <Graphic icon="peopleIcon.png" slide="14" itemNumber="1" iconLocation={['24vw',0]} initHouseSize={this.state.houseSize} relWidth='4vw' currentSlide={this.state.currentSlide} />
        ...
        <Graphic icon="peopleIcon.png" slide="15" itemNumber="1" iconLocation={['24vw',0]} initHouseSize={this.state.houseSize} relWidth='4vw' currentSlide={this.state.currentSlide} />
        <Graphic icon="peopleIcon.png" slide="16" itemNumber="1" iconLocation={['24vw',0]} initHouseSize={this.state.houseSize} relWidth='4vw' currentSlide={this.state.currentSlide} />
        ...
        <Graphic icon="peopleIcon.png" slide="17" itemNumber="1" iconLocation={['24vw',0]} initHouseSize={this.state.houseSize} relWidth='4vw' currentSlide={this.state.currentSlide} />
      </div>
    );
  }
}
