    ...
    return (
      <div>
        <div id="sky">
          ...
          <div id="clouds">
            <div className="cloud x1"><img src="images/cloud.png" /></div>
            <div className="cloud x2"><img src="images/cloud.png" /></div>
            <div className="cloud x3"><img src="images/cloud.png" /></div>
            <div className="cloud x4"><img src="images/cloud.png" /></div>
            <div className="cloud x5"><img src="images/cloud.png" /></div>
            ...
            <div className="cloud x13"><img src="images/cloud.png" /></div>
            <div className="cloud x14"><img src="images/cloud.png" /></div>
            <div className="cloud x15"><img src="images/cloud.png" /></div>
            <div className="cloud x16"><img src="images/cloud.png" /></div>
          </div>
          <img id="houseTop" src="images/houseTop.png" />
        </div>
      </div>
    );
  }
